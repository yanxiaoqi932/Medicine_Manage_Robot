...
doctorBactButton::doctorBactButton(QString doctorBtnPath)
{
    doctorBackBtnPath = doctorBtnPath;  //按钮图片路径
    QPixmap pixmap;
    bool ret = pixmap.load(doctorBackBtnPath);
    if(!ret)
    {
        qDebug()<<doctorBackBtnPath<<"加载图片失败！";
    }
