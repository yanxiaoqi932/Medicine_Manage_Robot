...
clientBackButton::clientBackButton(QString clientBtnPath)
{
    clientBackBtnPath = clientBtnPath;  //按钮图片路径
    QPixmap pixmap;
    bool ret = pixmap.load(clientBackBtnPath);
    if(!ret)
    {
        qDebug()<<clientBackBtnPath<<"加载图片失败！";
    }
